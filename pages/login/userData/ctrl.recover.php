...
if (isset($_POST['submit']) && !empty($_POST['username'])) {
    ...
    $guidance = $db->query("SELECT * FROM tbl_guidances WHERE username = '$username'");
    $numrow9 = $teacher->num_rows;
    ...
    if ($numrow > 0) {
        ...
        $query1 = $db->query("UPDATE tbl_guidances SET activation_code = '$randNum' WHERE username = '$username'");
    } else {
    ...
    try {
        ...
        $mail->Password   = '03132804Jason';                               //SMTP password 4_J@son

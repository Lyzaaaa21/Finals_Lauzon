...
?>
<title>
    Guidance Counselors List | SFAC - Bacoor
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View Guidance Counselors List</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">Guidance Counselors List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover responsive nowrap" style="width: 100%;"
                                ...
                                <tbody>
                                    <?php
                                    $listGuidance = mysqli_query($db, "SELECT *, CONCAT(tbl_guidances.guidance_lastname, ', ', tbl_guidances.guidance_firstname, ' ', tbl_guidances.guidance_middlename) AS fullname FROM tbl_guidances");
                                    while ($row = mysqli_fetch_array($listGuidance)) {
                                        $id = $row['guidance_id'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['guidance_lastname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['guidance_firstname']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['guidance_middlename']; ?></td>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.guidance.php?guidance_id=<?php echo $id; ?>"><i
                                        ...
                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.guidance.php?guidance_id=<?php echo $id; ?>"

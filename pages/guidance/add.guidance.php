            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <h3>Input the Guidance information</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8 m-auto">
                                <form class="multisteps-form__form mb-8" method="POST" enctype="multipart/form-data"
                                    action="userData/ctrl.add.guidance.php">
                                    <!--single form panel-->
                                    <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                                        data-animation="FadeIn">
                                        <h5 class="font-weight-bolder mb-0">Add Guidance </h5>
                                        ...
                                        <div class="multisteps-form__content">
                                            ...
                                            <div class="row mt-3 justify-content-center">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <label>Guidance Number</label>
                                                    <input class="multisteps-form__input form-control" type="text"
                                                        placeholder="Enter a guidance number" name="guidance_no" />
                                                </div>
                                            </div>

    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <?php
                                $getUserData = mysqli_query($db, "SELECT *, CONCAT(tbl_guidances.guidance_firstname, ' ', tbl_guidances.guidance_middlename, ' ', tbl_guidances.guidance_lastname) AS fullname FROM tbl_guidances WHERE guidance_id = '$guidance_id'");
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.guidance.php"
                ...
                <form method="POST" enctype="multipart/form-data" action="userData/ctrl.edit.guidance.php"
                    ...
                    <div class="card-body pt-0">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="lastName" name="lname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['guidance_lastname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="firstName" name="fname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['guidance_firstname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="middlename" name="mname" class="form-control" type="text"
                                        placeholder="Middlename" value="<?php echo $row['guidance_middlename']; ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label class="form-label mt-4">Guidance Number</label>
                                <div class="input-group">
                                    <input id="text" name="guidance_no" class="form-control" type="text"
                                        placeholder="Enter a guidance number" value="<?php echo $row['guidance_no']; ?>"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" name="status" id="status">
                                    <?php $getStatus = mysqli_query($db, "SELECT * FROM tbl_guidances WHERE guidance_id = '$guidance_id'");
                ...
                <form class="card mt-4 mb-5" id="password" method="POST" action="userData/ctrl.edit.guidance.php">
                    <div class="card-header">

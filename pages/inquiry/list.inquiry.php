                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="row d-flex justify-content-center mx-4">
                            <div class="col-md-6 m-1 ">
                                <form method="GET" action="list.inquiry.php">
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover m-0 responsive nowrap" id="datatable-basic"
                                ...
                                <tbody>
                                    ...
                                    $listInquiries = mysqli_query(
                                        $db, 
                                        "SELECT *, CONCAT(tbl_online_registrations.lastname, ', ', tbl_online_registrations.firstname, ' ', tbl_online_registrations.middlename) AS fullname 
                                            ...
                                            semester LIKE '%$_GET[search_text]%' OR
                                            contact LIKE '%$_GET[search_text]%' OR
                                            email LIKE '%$_GET[search_text]%' OR
                                            lastschool LIKE '%$_GET[search_text]%'OR
                                            last_school_type LIKE '%$_GET[search_text]%' OR
                                            info_name LIKE '%$_GET[search_text]%' OR
                                            status LIKE '%$_GET[search_text]%' OR
                                            created_at LIKE '%$_GET[search_text]%')

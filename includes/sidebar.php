<aside
    ...
    <div class="sidenav-header">
        ...
        <div class="border-0 d-flex align-items-center px-0 mt-3">
            ...
            } elseif ("Guidance" == $_SESSION['role']) {
                $getUserName = mysqli_query($db, "SELECT *, CONCAT(tbl_guidances.guidance_lastname, ', ', tbl_guidances.guidance_firstname) AS fullname FROM tbl_guidances WHERE guidance_id = '$guidance_id'");
                while ($row = mysqli_fetch_array($getUserName)) {
                    echo '<img src="data:image/jpeg;base64,' . base64_encode($row['img']) . '" class="border-radius-lg mx-3 shadow zoom" alt="main_logo" style="height: 40px; width: 40px;">
            <div class="d-flex align-items-start flex-column justify-content-center">
                <h6 class="mb-0 text-sm">' . $row['fullname'] . '</h6>
    ...
    <div class="collapse navbar-collapse  w-auto max-height-vh-90" id="sidenav-collapse-main">
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../guidance/list.guidance.php">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="far fa-list-alt text-dark" style="height: 12px; width: 12px;"></i>
                </div>
                <span class="nav-link-text ms-1">Guidance List</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../guidance/add.guidance.php">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-plus text-dark"></i>
                </div>
                <span class="nav-link-text ms-1">Add Guidance Counselor</span>
            </a>
        </li>
...
<li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="newcurri23">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BECED.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BECED</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BEED.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BEED</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSEMATH.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-MATH</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BPED.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BPED</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSEDEng.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-Eng</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSEDSS.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-SS</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSEFILIPINO.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-FILIPINO</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../23_curri/BSESCIENCE.php">
                                            <span class="sidenav-mini-icon text-xs"> </span>
                                            <span class="sidenav-normal text-black-50">BSED-SCIENCE</span>
                                        </a>
                                    </li>
        ...
        <li class="nav-item mt-3">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Announcement</h6>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../admission/add.announcement.php">
                    ...
                    <span class="nav-link-text ms-1">Add Announcements</span>
                </a>
            </li>
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Fees Assessment Settings</h6>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="../assessment/add.discount.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add Discounts</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="../assessment/add.miscell.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../assessment/add.lab.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../assessment/add.tuition.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add Tuition Fees</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../assessment/add.installment.date.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add Installment Due Dates</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="../assessment/list.discount.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">List Discounts</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="../assessment/list.miscell.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../assessment/list.lab.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../assessment/list.tuition.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">List Tuition Fees</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../assessment/list.installment.date.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">List Installment Dates</span>
                </a>
            </li>
            ';
                ...
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../enrollment/enrollment.history.php">
                            <span class="sidenav-mini-icon"> </span>
                            <span class="sidenav-normal font-weight-bold">Enrolled History</span>
                        </a>
                    </li>
                ...
                <div class="collapse" id="lists">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../guidance/list.guidance.php">
                                <span class="sidenav-mini-icon"> </span>
                                <span class="sidenav-normal font-weight-bold">Guidance Counselors List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../adviser/list.adviser.php">
                ...
                <div class="collapse" id="maintenance">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../guidance/add.guidance.php">
                                <span class="sidenav-mini-icon text-xs"> </span>
                                <span class="sidenav-normal font-weight-bold">Add Guidance Counselor</span>
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        ';
            ...
            } else if ($_SESSION['role'] == "Guidance") {
                echo '
            <li class="nav-item">
                <a class="nav-link  active" href="../dashboard/index.php">
                    <div
                ...
                <div class="collapse" id="maintenance">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../guidance/add.guidance.php">
                                <span class="sidenav-mini-icon text-xs"> </span>
                                <span class="sidenav-normal font-weight-bold">Add Guidance Counselors</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../course/add.course.php">
    ...
    <div class="sidenav-footer mx-3">
        ...
        elseif ($_SESSION['role'] == "Dean") {
            ...
            if ($_SESSION['userid'] == 12 || $_SESSION['userid'] == 13 || $_SESSION['userid'] == 7 || $_SESSION['userid'] == 3) {
